...
- **Phase A: Definition:** `planner` fetches 1 issue -> `designer` generates **Detailed Mermaid User Flow** & High-Fidelity UI/UX Specification (via `/impeccable`) -> `planner`+`lead-dev` refine & cache -> **USER APPROVAL**.
